class DrawingsController < ApplicationController
  ...
  def index
    ...
    @drawing_illustration = Drawing.where(genre_id: 2)
    @drawing_manga = Drawing.where(genre_id: 3)
    @drawing_portrait = Drawing.where(genre_id: 9)
    @drawing_poster = Drawing.where(genre_id: 4)
  end
